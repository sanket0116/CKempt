              ...
              {isServicesDropdownOpen && (
                ...
                >
                  ...
                  <div className="bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
                    {/* Service Categories */}
                    <div className="p-4">
                      <h3 className="text-xs font-bold text-gray-900 mb-2">Our Services</h3>
                      <div className="grid grid-cols-3 gap-2">
                        <Link
                          href="/services/category/cloud"
                          className="group flex flex-col items-center text-center gap-1.5 p-2 bg-gray-50 rounded-lg hover:bg-[#FBB900]/10 hover:border-[#FBB900] border border-gray-100 transition-all duration-300"
                          onClick={() => setIsServicesDropdownOpen(false)}
                        >
                          <div className="w-8 h-8 bg-[#FBB900]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg className="w-4 h-4 text-[#FBB900]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                            </svg>
                          </div>
                          <div>
                            <h4 className="text-xs font-semibold text-gray-900 group-hover:text-[#FBB900] transition-colors">Cloud</h4>
                            <p className="text-[10px] text-gray-500">Migration & Infra</p>
                          </div>
                        </Link>
                        ...
                        >
                          ...
                          <div>
                            <h4 className="text-xs font-semibold text-gray-900 group-hover:text-[#FBB900] transition-colors">DevOps</h4>
                            <p className="text-[10px] text-gray-500">CI/CD & IaC</p>
                          </div>
                        </Link>
                        ...
                        >
                          ...
                          <div>
                            <h4 className="text-xs font-semibold text-gray-900 group-hover:text-[#FBB900] transition-colors">Kubernetes</h4>
