...
export const allServices: Service[] = [
  ...
  // ========== KUBERNETES SERVICES ==========
  {
    ...
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v4a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
      </svg>
    ),
    excerpt: 'Expert guidance and best practices for your Kubernetes journey',
    description: 'Get expert consulting services to design, implement, and optimize your Kubernetes infrastructure. Our certified Kubernetes experts will help you navigate the complexities of container orchestration and build a robust, scalable platform.',
    features: [
  ...
  },
  {
    ...
    excerpt: 'Fully managed Kubernetes service with 24/7 support',
    description: 'Focus on your applications while we handle the Kubernetes infrastructure. Our managed service includes monitoring, patching, updates, and expert support to keep your clusters running smoothly.',
    features: [
  ...
  },
  {
    ...
    excerpt: 'Comprehensive training programs for teams of all skill levels',
    description: 'Upskill your team with our hands-on Kubernetes training programs. From beginner to advanced levels, we offer customized training to match your team\'s needs and accelerate your cloud-native journey.',
    features: [
  ...
  },
  {
    ...
    excerpt: 'Seamless migration of your applications to Kubernetes',
    description: 'Migrate your applications to Kubernetes with minimal downtime. Our experts will assess your current infrastructure, plan the migration, and execute it with precision to ensure a smooth transition.',
    features: [
  ...
  },
  {
    ...
    excerpt: 'Comprehensive security solutions for your Kubernetes clusters',
    description: 'Protect your Kubernetes environment with our comprehensive security solutions. From cluster hardening to runtime protection, we ensure your containerized applications are secure and compliant.',
    features: [
      'Cluster hardening',
      'Network policies',
      'Runtime security',
  ...
  },
  {
    ...
    excerpt: 'Enterprise-grade Kubernetes solutions for container orchestration',
    description: 'Deploy, manage, and scale containerized applications with our comprehensive Kubernetes solutions. We provide end-to-end Kubernetes services from cluster setup to application deployment and monitoring.',
    features: [
...
export const categorizedServices = {
  ...
  kubernetes: allServices.filter(s => s.category === 'kubernetes').map(s => ({
    slug: s.slug,
    title: s.title,
    icon: s.icon,
    excerpt: s.excerpt
...
export const getServicesByCategory = (category: 'cloud' | 'devops' | 'kubernetes' | 'ai'): Service[] => {
